...
if ($mailOk && $email) {
    ...
    $replySubject = "Thank you — CrossGate Legal has received your request";
    $replyBody = "
<html>
...
<p style='font-size:14px;color:#7A8880;line-height:1.7;margin:0 0 20px'>We've received your request regarding <strong style='color:#E4CC9F'>$supplier</strong> in <strong style='color:#E4CC9F'>$juris</strong>.</p>
</td></tr>
